...
public class Constants {
    ...
    public static final String CODENVY_CONFIG_FILE =
            System.getProperty("karaf.home") + File.separatorChar + "etc" + File.separatorChar + "codenvy.cfg";
    ...
    /**
     * Define the <b>password</b> property which is defined in the codenvy configuration file.
     */
